                            ...
                            <div className="chart">
                                <div className="chart__names">
                                    <ul className="chart__list">
                                        <li className="chart__item active"
                                            data-tab
                                            data-price-token-today="0.1703 $"
                                            data-price-today="10 138.31 $"
                                            data-private-price="0.017 $"
                                            data-entry-price="1000 $"
                                            data-profit="913.83 %"
                                            data-entry="18 february 2022"
                                            data-logo-src={ErthaLogo}
                                            data-name="ERTHA"
                                        >
                                            <div className="img-wrap">
                                                <img src={ErthaLogo} alt=""
                                                     className="img"/>
                                            </div>
                                            <span className="name">ERTHA</span>
                                        </li>
                                        <li className="chart__item"
                                            data-tab
                                            data-price-token-today="0.05509 $"
                                            data-price-today="55 270.61 $"
                                            data-private-price="0.001 $"
                                            data-entry-price="1000 $"
                                            data-profit="5427.06 %"
                                            data-entry="19 february 2022"
                                            data-logo-src={SidusLogo}
                                            data-name="SIDUS"
                                        >
                                            <div className="img-wrap">
                                                <img src={SidusLogo} alt=""
                                                     className="img"/>
                                            </div>
                                            <span className="name">SIDUS</span>
                                        </li>
                                        <li className="chart__item"
                                            data-tab
                                            data-price-token-today="1.588 $"
                                            data-price-today="15 905.51 $"
                                            data-private-price="0.1 $"
                                            data-entry-price="1000 $"
                                            data-profit="1490.55 %"
                                            data-entry="19 february 2022"
                                            data-logo-src={SenateLogo}
                                            data-name="SENATE"
                                        >
                                            <div className="img-wrap">
                                            ...
                                            <span className="name">SENATE</span>
                                        </li>
                                        <li className="chart__item"
                                            data-tab
                                            data-price-token-today="0.2798 $"
                                            data-price-today="96 935.27 $"
                                            data-private-price="0.00295 $"
                                            data-entry-price="1000 $"
                                            data-profit="9593.53 %"
                                            data-entry="19 february 2022"
                                            data-logo-src={VRLogo}
                                            data-name="VR"
                                        >
                                            <div className="img-wrap">
                                                <img src={VRLogo} alt=""
                                            ...
                                            <span className="name">vr</span>
                                        </li>
                                        <li className="chart__item"
                                            data-tab
                                            data-price-token-today="0.4224 $"
                                            data-price-today="14 966.85 $"
                                            data-private-price="0.028 $"
                                            data-entry-price="1000 $"
                                            data-profit="1396.69 %"
                                            data-entry="19 february 2022"
                                            data-logo-src={CWARLogo}
                                            data-name="CWAR"
                                        >
                                            <div className="img-wrap">
                                                <img src={CWARLogo} alt=""
                                                     className="img"/>
                                            </div>
                                            <span className="name">CWAR</span>
                                        </li>
                                        <li className="chart__item"
                                            data-tab
                                            data-price-token-today="0.3183 $"
                                            data-price-today="8 069.26 $"
                                            data-private-price="0.04 $"
                                            data-entry-price="1000 $"
                                            data-profit="706.93 %"
                                            data-entry="19 february 2022"
                                            data-logo-src={CpollLogo}
                                            data-name="CPOOL"
                                        >
                                            <div className="img-wrap">
                                                <img src={CpollLogo} alt=""
                                                     className="img"/>
                                            </div>
                                            <span className="name">CPOOL</span>
                                        </li>
                                    </ul>
                                </div>
                                <div className="chart__content" data-chart-content>
                                    <div className="chart__content-info">
                                        <span id="chart-name" className="name">ERTHA</span>
                                        <div className="img-wrap">
                                            <img id="chart-logo" src="./images/dist/company-logos/ertha-logo.png" alt=""
                                                 className="img"/>
                                        </div>
                                        <div className="profit">
                                            <span className="profit__title">Profit %</span>
                                            <span id="profit-percent" className="profit__percent">913.83 %</span>
                                        </div>
                                    </div>
                                    <div className="chart__content-entry">
                                        Entry : <span id="entry-info">18 february 2022</span>
                                    </div>
