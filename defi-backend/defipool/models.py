...
class MyPortfolioProjectModel(models.Model):
    ...
    my_investment = models.TextField(verbose_name='Мои инвестиции', default="-")
    blockchain = models.CharField(max_length=100, default="-")
    info = models.TextField(verbose_name='Описание / Информация о монете', default="-")
    entry_date = models.TextField(verbose_name='Дата входа', default="-")
    tge = models.TextField(default="-")
